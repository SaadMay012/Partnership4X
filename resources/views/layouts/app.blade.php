...
<body>
        ...
        <div class="container dasktopContainer d-none d-lg-block ">
            <div class="row">
                ...
                <div class="col-sm-1 col-md-1">
                    <div class="logo">
                        <a href="{{ route('web.home.index') }}"><img src="{{ URL::to('/web') }}/img/logo.png"></a>
                    </div>
                </div>
                    ...
                    <nav>
                        <ul class="nav  justify-content-end">
                            ...
                            <li class="nav-item"><a class="nav-link btn btn-primary"
                                    href="{{ route('web.home.index') }}">@lang('translation.application_center')</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <!-- logo -->
                        <a class="navbar-brand" href="#"><img src="{{ URL::to('/web') }}/img/logo.png"></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6">
                    <ul class="nav justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ URL::to('/login') }}"><img
                                    src="{{ URL::to('/web') }}/icons/user.png">@lang('translation.user')</a>
                        </li>
                        @if (Session::has('user'))
                            <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><img
                                    src="{{ URL::to('/web') }}/icons/phone.png">@lang('translation.call_canter')</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ URL::to('/web') }}/icons/lang.png">
                ...
                <div class="col-sm-6 col-md-6">
                    <nav>
                        <ul class="nav  justify-content-end">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#">Legal notes & Privacy Policy</a>
                            </li>
    ...
    <!--	Js Link
  ============================================================-->
    <script src="{{ asset('/web/js/bundle.js') }}"></script>
