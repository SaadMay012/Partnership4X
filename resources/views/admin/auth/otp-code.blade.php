    ...
    <main class="auth">
        ...
        <form class="auth-form auth-form-reflow" onsubmit="return false;">
            ...
            <div class="form-group mb-4">
                <label class="d-block text-left" for="otp_code">OTP CODE</label> <input type="number" name="otp_code"
                    id="otp_code" class="form-control form-control-lg" required="" autofocus="">
                <p id="message">
                </p>
            </div>
            <!-- /.form-group -->
